...
jQuery(document).ready(function($) {
    ...
    jQuery("#preloader-<?php echo $rnd; ?>").fadeOut(500, function() {
    ...
    ?>
            ...
            messages: {
                <?php
if ( $opt['frmerrmsg'] != 'none' ) {echo $opt['frmelvalmsg'];}
    ?>
            },
            ...
            success: function(data) {
                ...
                if (data.Ok == true) {
                    ...
                    if (data.msg == 'redirect') {
                        ...
                        notifyme('<?php echo $opt['actafter'][1]; ?>', 'n', 'success',
                            'left middle');
                    }
...
<div id="preloader-<?php esc_attr_e( $rnd );?>" class="ecfpreloader"></div>
<div id="ecf-form-<?php esc_attr_e( $rnd );?>" class="ecf-body" style="display:none;">
    <form method="post" enctype="multipart/form-data" action="#" id="form-<?php esc_attr_e( $rnd );?>"
        class="ecf-form form-<?php esc_attr_e( $rnd );?>">
        <?php echo $isheader; ?>
        <fieldset>
            <?php
    ...
    ?>
        ...
        <footer>
            <button data-style="slide-down" id="cf-submitted<?php esc_attr_e( $rnd );?>" class="ecfbutton ladda-button"
                type="submit" name="cf-submitted<?php esc_attr_e( $rnd );?>"><span
...
if ( ecf_get_aff_option( 'ecf_affiliate_info', 'ecf_aff_id', '' ) ) {?>
    <span class="ecf-aff-link">Powered by <a
            href="https://secure.ghozylab.com/demo/?ref=<?php echo ecf_get_aff_option( 'ecf_affiliate_info', 'ecf_aff_id', '' ); ?>&goto=ecf"
