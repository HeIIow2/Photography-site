  ...
  <div class="tsc_pricingtable03 tsc_pt3_style1" style="margin-bottom:110px; height:1100px;">
    ...
    <div class="column_2">
      <ul>
        ...
        <li class="row_style_2 align_center"><span style="font-weight: bold; color:#F77448; font-size:14px;">1 Site</span></li>
        <li class="footer_row"><a target="_blank" href="https://ghozylab.com/plugins/ordernow.php?order=ecfpro&utm_source=contactform&utm_medium=pricingpage&utm_campaign=pricingpage" class="tsc_buttons2 blue">Upgrade Now</a></li>
      </ul>
    </div>    
    ...
    <span class="bestbuy"></span>
      <ul>
        ...
        <li class="row_style_4 align_center"><span>1 Year</span></li>
        <li class="row_style_2 align_center"><span style="font-weight: bold; color:#F77448; font-size:14px;">3 Sites</span></li>
        <li class="footer_row"><a target="_blank" href="https://ghozylab.com/plugins/ordernow.php?order=ecfproplus&utm_source=contactform&utm_medium=pricingpage&utm_campaign=pricingpage" class="tsc_buttons2 orange">Upgrade Now</a></li>
      </ul>
    </div>
    <div class="column_2">
      <ul>
        ...
        <li class="row_style_4 align_center"><span>1 Year</span></li>
        <li class="row_style_2 align_center"><span style="font-weight: bold; color:#F77448; font-size:14px;">5 Sites</span></li>
        <li class="footer_row"><a target="_blank" href="https://ghozylab.com/plugins/ordernow.php?order=ecfproplusplus&utm_source=contactform&utm_medium=pricingpage&utm_campaign=pricingpage" class="tsc_buttons2 green">Upgrade Now</a></li>
      </ul>
    </div>    
     <div class="column_4">
      <ul>
        ...
        <li class="row_style_1 align_center"><span style="font-weight: bold; color: #F77448; font-size:14px;">15 Sites</span></li>
        <li class="footer_row"><a target="_blank" href="https://ghozylab.com/plugins/ordernow.php?order=ecfdev&utm_source=contactform&utm_medium=pricingpage&utm_campaign=pricingpage" class="tsc_buttons2 red">Upgrade Now</a></li>
      </ul>
    </div>   
